...
Widget doctorDetailWidget(BuildContext context, {String? image, String? title, String? subTitle, Color? bgColor}) {
  return Row(
    children: [
      Container(
      ...
      Column(
        ...
        children: [
          ...
          8.height,
          Text(subTitle.validate(), style: boldTextStyle(size: 16)),
        ],
      ).expand(),
    ],
  ).withWidth(context.width() / 2 - 22);
}
